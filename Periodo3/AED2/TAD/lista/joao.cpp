...
void IntercalaLista(corpoLista x, corpoLista y, int tamanho, int tamanho1)
{
...
main()
{
    ...
    int tamanho = 0, numero, tamanho1 = 0, escolha = 0, somatorio = 0, posicao = 0;
    ...
    IntercalaLista(lista1,lista2, tamanho, tamanho1);
    cout<<endl;

    ListaParImpar(lista1);
    cout<<endl;

    somatorio = somatorioElementosLista(lista1);
    cout<<"Na lista 1 tem "<<somatorio<<" elementos."<<endl;

    somatorio = somatorioElementosLista(lista2);
    cout<<"Na lista 2 tem "<<somatorio<<" elementos."<<endl;
    cout<<endl;

    cout<<"Digite uma posição que o programa vai retornar o elemento da lista 1"<<endl;
    cin>>posicao;
    procuraElementosNaLista(lista1, posicao);
    cout<<endl;

    cout<<"Digite uma posição que o programa vai retornar o elemento da lista 2"<<endl;
    cin>>posicao;
    procuraElementosNaLista(lista2, posicao);
}
