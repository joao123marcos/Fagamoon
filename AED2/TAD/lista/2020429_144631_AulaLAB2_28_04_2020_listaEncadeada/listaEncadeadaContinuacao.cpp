...
/*
função listaVazia(lista: tipoLista): lógico;
inicio
	se(lista.primeiro == lista.ultimo) então
		retorna verdadeiro;
	senão
		retorna falso;
	fim-se;
...
inicio
	achou = false;
	se(listaVazia(lista) == falso) então
		aux = lista.primeiro->prox;
...
/* Função que busca na lista e retorna verdadeiro ou falso
função buscaNalistaFuncBool(lista:tipoLista; n: inteiro): lógico;
declare
	aux: ponteiro para tipoNo;
inicio
	se(listaVazia(lista) == falso) então
...
/* Função que busca na lista e retorna a posição do elemento.
função buscaNaListaFuncPos(lista:tipoLista; n: inteiro): inteiro;
declare
	aux: ponteiro para tipoNo;
	cont: inteiro;
inicio
...
/*função somaElementosDaLista(lista: tipoLista): inteiro;
declare
	aux: ponteiro para nó;
	soma: inteiro;
inicio
	soma = 0;
	se (listaVazia(lista) == falso) então
...
/*
função removePrimeiro(var lista:tipoLista): inteiro;
declare
	aux: ponteiro para nó;
	num: inteiro;
inicio
	se(listaVazia(lista) == verdadeiro) então
		retorna 0;
	senão
