...
class Agencia{
    ...
    /*Este metodo está sendo criado para que eu possa ter acesso ao vetor de contas e com isso eu poder acessar os atributos de cada conta
    (como saldo, fazer um saque e etc)*/
    public conta[] getContasNaAgencia(){
        return this.contasDestaAgencia;
    }
...
{ 
	public static void main(String[] args) {
	    ...
	    Agencia agLavras = new Agencia("Agencia de lavras banco do brasil", 100);
	    ...
	    //preciso de alguma forma receber o vetor com as contas da minha agencia
	    conta[] vetContasAgencia = agLavras.getContasNaAgencia();
	    
	    /*Então agora eu consigo acessar os atributos de uma conta, pois a variável vetContasAgencia armazena uma vetor de objetos conta
	    e com isso eu consigo acessar os atributos de cada conta e manipula-los*/
	    System.out.println("Saldo da conta na primeira posição do vetor "+ vetContasAgencia[0].getSaldo());
	    
	    //acessando um metodo da classe conta 
	    vetContasAgencia[0].depositar(1000);
	    System.out.println("Saldo da conta na primeira posição do vetor "+ vetContasAgencia[0].getSaldo());
	    
	    vetContasAgencia[0].setDono("João Marcos");
	    System.out.println("Dono da conta "+ vetContasAgencia[0].getDono());
	}
